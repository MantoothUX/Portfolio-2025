...
const ProjectDetail = ({
  ...
  return <motion.div initial={{
    ...
    opacity: 0
  }} className="min-h-screen pb-24" data-magicpath-id="24" data-magicpath-path="PortfolioWebsite.tsx">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12" data-magicpath-id="25" data-magicpath-path="PortfolioWebsite.tsx">
        <button onClick={onBack} className="flex items-center gap-2 text-green-700 dark:text-green-400 hover:text-[#13531C] dark:hover:text-green-100 transition-colors mb-8" data-magicpath-id="26" data-magicpath-path="PortfolioWebsite.tsx">
          <ArrowLeft className="w-5 h-5" data-magicpath-id="27" data-magicpath-path="PortfolioWebsite.tsx" />
          Back to projects
        </button>
        ...
        delay: 0.1
      }} data-magicpath-id="28" data-magicpath-path="PortfolioWebsite.tsx">
          <div className="mb-6" data-magicpath-id="29" data-magicpath-path="PortfolioWebsite.tsx">
            <div className="flex items-center gap-4 text-sm text-green-600 dark:text-green-400 mb-4" data-magicpath-id="30" data-magicpath-path="PortfolioWebsite.tsx">
              <span data-magicpath-id="31" data-magicpath-path="PortfolioWebsite.tsx">{project.company}</span>
              <span data-magicpath-id="32" data-magicpath-path="PortfolioWebsite.tsx">•</span>
              <span data-magicpath-id="33" data-magicpath-path="PortfolioWebsite.tsx">{project.year}</span>
              <span data-magicpath-id="34" data-magicpath-path="PortfolioWebsite.tsx">•</span>
              <span data-magicpath-id="35" data-magicpath-path="PortfolioWebsite.tsx">{project.role}</span>
            </div>
            <h1 className="text-4xl sm:text-5xl font-bold text-[#13531C] dark:text-green-100 mb-4" data-magicpath-id="36" data-magicpath-path="PortfolioWebsite.tsx">{project.title}</h1>
            <p className="text-xl text-green-700 dark:text-green-300" data-magicpath-id="37" data-magicpath-path="PortfolioWebsite.tsx">{project.description}</p>
          </div>

          <div className="flex flex-wrap gap-2 mb-8" data-magicpath-id="38" data-magicpath-path="PortfolioWebsite.tsx">
            {project.tags.map(tag => <span key={tag} className="px-4 py-2 text-sm font-medium text-green-800 dark:text-green-300 bg-green-50 dark:bg-[#0f2912] rounded-full" data-magicpath-id="39" data-magicpath-path="PortfolioWebsite.tsx">
                {tag}
              </span>)}
          </div>

          <div className="rounded-2xl overflow-hidden mb-12" data-magicpath-id="40" data-magicpath-path="PortfolioWebsite.tsx">
            <img src={project.image} alt={project.title} className="w-full h-auto" data-magicpath-id="41" data-magicpath-path="PortfolioWebsite.tsx" />
          </div>

          <div className="space-y-12" data-magicpath-id="42" data-magicpath-path="PortfolioWebsite.tsx">
            <section data-magicpath-id="43" data-magicpath-path="PortfolioWebsite.tsx">
              <h2 className="text-2xl font-bold text-[#13531C] dark:text-green-100 mb-4" data-magicpath-id="44" data-magicpath-path="PortfolioWebsite.tsx">Overview</h2>
              <p className="text-green-700 dark:text-green-300 leading-relaxed" data-magicpath-id="45" data-magicpath-path="PortfolioWebsite.tsx">{project.overview}</p>
            </section>

            <section data-magicpath-id="46" data-magicpath-path="PortfolioWebsite.tsx">
              <h2 className="text-2xl font-bold text-[#13531C] dark:text-green-100 mb-4" data-magicpath-id="47" data-magicpath-path="PortfolioWebsite.tsx">Challenges</h2>
              <ul className="space-y-3" data-magicpath-id="48" data-magicpath-path="PortfolioWebsite.tsx">
                {project.challenges.map((challenge, index) => <li key={index} className="flex gap-3" data-magicpath-id="49" data-magicpath-path="PortfolioWebsite.tsx">
                    <span className="text-green-500 dark:text-green-500 font-medium" data-magicpath-id="50" data-magicpath-path="PortfolioWebsite.tsx">•</span>
                    <span className="text-green-700 dark:text-green-300" data-magicpath-id="51" data-magicpath-path="PortfolioWebsite.tsx">{challenge}</span>
                  </li>)}
              </ul>
            </section>

            <section data-magicpath-id="52" data-magicpath-path="PortfolioWebsite.tsx">
              <h2 className="text-2xl font-bold text-[#13531C] dark:text-green-100 mb-4" data-magicpath-id="53" data-magicpath-path="PortfolioWebsite.tsx">Solutions</h2>
              <ul className="space-y-3" data-magicpath-id="54" data-magicpath-path="PortfolioWebsite.tsx">
                {project.solutions.map((solution, index) => <li key={index} className="flex gap-3" data-magicpath-id="55" data-magicpath-path="PortfolioWebsite.tsx">
                    <span className="text-green-500 dark:text-green-500 font-medium" data-magicpath-id="56" data-magicpath-path="PortfolioWebsite.tsx">•</span>
                    <span className="text-green-700 dark:text-green-300" data-magicpath-id="57" data-magicpath-path="PortfolioWebsite.tsx">{solution}</span>
                  </li>)}
              </ul>
            </section>

            <section data-magicpath-id="58" data-magicpath-path="PortfolioWebsite.tsx">
              <h2 className="text-2xl font-bold text-[#13531C] dark:text-green-100 mb-4" data-magicpath-id="59" data-magicpath-path="PortfolioWebsite.tsx">Outcomes</h2>
              <div className="grid sm:grid-cols-3 gap-6" data-magicpath-id="60" data-magicpath-path="PortfolioWebsite.tsx">
                {project.outcomes.map((outcome, index) => <div key={index} className="p-6 bg-green-50 dark:bg-[#0f2912] rounded-xl border border-green-200 dark:border-green-900/50" data-magicpath-id="61" data-magicpath-path="PortfolioWebsite.tsx">
                    <p className="text-[#13531C] dark:text-green-100 font-medium" data-magicpath-id="62" data-magicpath-path="PortfolioWebsite.tsx">{outcome}</p>
                  </div>)}
              </div>
            </section>
          </div>
...
const AboutPage = () => {
  return <motion.div initial={{
    ...
    opacity: 0
  }} className="min-h-screen pb-24" data-magicpath-id="63" data-magicpath-path="PortfolioWebsite.tsx">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12" data-magicpath-id="64" data-magicpath-path="PortfolioWebsite.tsx">
        <motion.div initial={{
        y: 20,
        opacity: 0
      }} animate={{
        ...
        delay: 0.1
      }} className="space-y-12" data-magicpath-id="65" data-magicpath-path="PortfolioWebsite.tsx">
          <div data-magicpath-id="66" data-magicpath-path="PortfolioWebsite.tsx">
            <h1 className="text-4xl sm:text-5xl font-bold text-[#13531C] dark:text-green-100 mb-6" data-magicpath-id="67" data-magicpath-path="PortfolioWebsite.tsx">About Me</h1>
            <div className="space-y-4 text-green-700 dark:text-green-300 leading-relaxed" data-magicpath-id="68" data-magicpath-path="PortfolioWebsite.tsx">
              <p data-magicpath-id="69" data-magicpath-path="PortfolioWebsite.tsx">
              ...
              <p data-magicpath-id="70" data-magicpath-path="PortfolioWebsite.tsx">
          ...
          <div data-magicpath-id="72" data-magicpath-path="PortfolioWebsite.tsx">
            <h2 className="text-2xl font-bold text-[#13531C] dark:text-green-100 mb-6" data-magicpath-id="73" data-magicpath-path="PortfolioWebsite.tsx">Skills & Expertise</h2>
            <div className="grid sm:grid-cols-2 gap-6" data-magicpath-id="74" data-magicpath-path="PortfolioWebsite.tsx">
              {[['User Research', 'Usability Testing', 'User Interviews', 'A/B Testing'], ['UI Design', 'Design Systems', 'Prototyping', 'Interaction Design'], ['Tools', 'Figma', 'Adobe XD', 'Principle', 'Framer'], ['Other', 'HTML/CSS', 'Design Thinking', 'Agile/Scrum']].map(([category, ...skills]) => <div key={category} className="space-y-3" data-magicpath-id="75" data-magicpath-path="PortfolioWebsite.tsx">
                  <h3 className="font-semibold text-[#13531C] dark:text-green-100" data-magicpath-id="76" data-magicpath-path="PortfolioWebsite.tsx">{category}</h3>
                  <ul className="space-y-2" data-magicpath-id="77" data-magicpath-path="PortfolioWebsite.tsx">
                    {skills.map(skill => <li key={skill} className="text-green-700 dark:text-green-300 text-sm flex items-center gap-2" data-magicpath-id="78" data-magicpath-path="PortfolioWebsite.tsx">
                        <span className="w-1.5 h-1.5 rounded-full bg-green-500 dark:bg-green-500" data-magicpath-id="79" data-magicpath-path="PortfolioWebsite.tsx" />
                        {skill}
                      </li>)}
                  </ul>
                </div>)}
          ...
          <div data-magicpath-id="80" data-magicpath-path="PortfolioWebsite.tsx">
            <h2 className="text-2xl font-bold text-[#13531C] dark:text-green-100 mb-6" data-magicpath-id="81" data-magicpath-path="PortfolioWebsite.tsx">Let's Connect</h2>
            <div className="flex flex-wrap gap-4" data-magicpath-id="82" data-magicpath-path="PortfolioWebsite.tsx">
              <a href="mailto:hello@example.com" className="flex items-center gap-2 px-6 py-3 bg-[#13531C] dark:bg-green-700 text-white dark:text-green-50 rounded-full hover:bg-green-800 dark:hover:bg-green-600 transition-colors" data-magicpath-id="83" data-magicpath-path="PortfolioWebsite.tsx">
                <Mail className="w-5 h-5" data-magicpath-id="84" data-magicpath-path="PortfolioWebsite.tsx" />
                Email Me
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 border border-green-300 dark:border-green-700 text-[#13531C] dark:text-green-100 rounded-full hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors" data-magicpath-id="85" data-magicpath-path="PortfolioWebsite.tsx">
                <Linkedin className="w-5 h-5" data-magicpath-id="86" data-magicpath-path="PortfolioWebsite.tsx" />
                LinkedIn
              </a>
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 border border-green-300 dark:border-green-700 text-[#13531C] dark:text-green-100 rounded-full hover:bg-green-50 dark:hover:bg-green-900/30 transition-colors" data-magicpath-id="87" data-magicpath-path="PortfolioWebsite.tsx">
                <Github className="w-5 h-5" data-magicpath-id="88" data-magicpath-path="PortfolioWebsite.tsx" />
                GitHub
              </a>
            </div>
          </div>
  ...
  return <motion.div initial={{
    ...
    opacity: 0
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-[linear-gradient(to_right,#13531C12_1px,transparent_1px),linear-gradient(to_bottom,#13531C12_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,#13531C40_1px,transparent_1px),linear-gradient(to_bottom,#13531C40_1px,transparent_1px)] bg-[size:20px_20px]" data-magicpath-id="90" data-magicpath-path="PortfolioWebsite.tsx">
        ...
        delay: 0.1
      }} className="mb-12" data-magicpath-id="91" data-magicpath-path="PortfolioWebsite.tsx">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#13531C] dark:text-green-100 mb-4" data-magicpath-id="92" data-magicpath-path="PortfolioWebsite.tsx">
            UX Designer crafting delightful experiences
          </h1>
          <p className="text-xl text-green-700 dark:text-green-300 max-w-3xl" data-magicpath-id="93" data-magicpath-path="PortfolioWebsite.tsx">
        ...
        delay: 0.2
      }} className="mb-8" data-magicpath-id="94" data-magicpath-path="PortfolioWebsite.tsx">
          <div className="flex flex-wrap gap-2" data-magicpath-id="95" data-magicpath-path="PortfolioWebsite.tsx">
            {companies.map(company => <button key={company} onClick={() => setSelectedCompany(company)} className={cn('px-4 py-2 rounded-full text-sm font-medium transition-all', selectedCompany === company ? 'bg-[#13531C] dark:bg-green-700 text-white dark:text-green-50' : 'bg-green-50 dark:bg-[#0f2912] text-green-800 dark:text-green-300 hover:bg-green-100 dark:hover:bg-green-900/50 border border-green-200 dark:border-green-900/50')} data-magicpath-id="96" data-magicpath-path="PortfolioWebsite.tsx">
                {company === 'all' ? 'All Projects' : company}
              </button>)}
          </div>
        </motion.div>

        <AnimatePresence mode="popLayout" data-magicpath-id="97" data-magicpath-path="PortfolioWebsite.tsx">
          <motion.div layout className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" data-magicpath-id="98" data-magicpath-path="PortfolioWebsite.tsx">
            {filteredProjects.map(project => <ProjectCard key={project.id} project={project} onClick={() => onProjectClick(project)} data-magicpath-id="99" data-magicpath-path="PortfolioWebsite.tsx" />)}
          </motion.div>
        </AnimatePresence>
      </div>
    </motion.div>;
...
export const PortfolioWebsite = (props: PortfolioWebsiteProps) => {
  ...
  // @return
  return <div className={cn('min-h-screen bg-white dark:bg-[#0a1f0d] transition-colors duration-300', props.className)} data-magicpath-id="100" data-magicpath-path="PortfolioWebsite.tsx">
      <Navigation currentPage={currentPage} onNavigate={page => setCurrentPage(page as 'home' | 'about')} darkMode={darkMode} onToggleDarkMode={toggleDarkMode} data-magicpath-id="101" data-magicpath-path="PortfolioWebsite.tsx" />
      
      <AnimatePresence mode="wait" data-magicpath-id="102" data-magicpath-path="PortfolioWebsite.tsx">
        {currentPage === 'home' && <HomePage key="home" onProjectClick={handleProjectClick} data-magicpath-id="103" data-magicpath-path="PortfolioWebsite.tsx" />}
        {currentPage === 'about' && <AboutPage key="about" data-magicpath-id="104" data-magicpath-path="PortfolioWebsite.tsx" />}
        {currentPage === 'project' && selectedProject && <ProjectDetail key="project" project={selectedProject} onBack={handleBackToHome} data-magicpath-id="105" data-magicpath-path="PortfolioWebsite.tsx" />}
      </AnimatePresence>
    </div>;
};