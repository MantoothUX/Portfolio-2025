...
export default function DoorHandleCheckin() {
  ...
  return (
    <div className={`min-h-screen ${isMobile ? 'bg-gray-50' : 'bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center p-8'}`}>
      {/* Mobile Phone Frame - iPhone 16 Plus - Hidden on mobile */}
      {!isMobile && (
        <div className="relative w-[430px] h-[932px] bg-black rounded-[3rem] p-2.5 border-[10px] border-gray-900">
      ...
      {/* Mobile View - Full Screen Content without Frame */}
      {isMobile && (
